        ...
        <section className="pt-16 sm:pt-24 lg:pt-32">
          ...
          >
            ...
            <p className="mt-6 text-xl leading-8 text-zinc-300 dark:text-zinc-300 light:text-zinc-600 max-w-3xl mx-auto">
              Create, deliver, and track hands-on coding lessons with live, in-browser execution and real-time feedback. Currently support browser-based Python, coming soon: SQL, JavaScript, and more.
            </p>
            ...
            <p className="mt-6 text-sm text-zinc-400 dark:text-zinc-400 light:text-zinc-500">Interactive coding platform • Real-time execution • Built for professionals</p>
          </motion.div>
          ...
          >
            ...
            <div className="mt-12 border-t border-white/10 pt-8 text-center">
              <p className="text-zinc-300">
                <strong className="text-white">All plans include:</strong> Cancel anytime
              </p>
            </div>
          </motion.div>
        </section>
