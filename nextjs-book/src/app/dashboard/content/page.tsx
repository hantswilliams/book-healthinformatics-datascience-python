                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {book.organizationId && book.accessType === 'ADMIN' && (
                      <>
                        ...
                        <button className="inline-flex items-center px-4 py-2 border border-gray-300 text-zinc-700 bg-white rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-colors text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-1 shadow-sm">
                          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
